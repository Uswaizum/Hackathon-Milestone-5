...
const formData = document.getElementById('resume-form') as HTMLFormElement;
const newResumeDisplayElement = document.getElementById('resume-display') as HTMLDivElement;
